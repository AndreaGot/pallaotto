...
namespace PallaOtto
{
    ...
    public partial class Page1 : PhoneApplicationPage
    {
        ...
        string[] risp = new string[9] {"Assolutamente no!", "Neanche per sogno!", "Non credo", "Forse..", "Non sono sicuro, riprova!", "Forse sì", "La vedo bene", "Certo!", "Assolutamente sì!"};

        public Page1()
        {
            InitializeComponent();
            introInd = rnd.Next(0,4);
            rispInd = rnd.Next(0,9);
        ...
        {
            ShareNewsArticle("Sto usando PallaOtto, e ho appena ricevuto la risposta: "  + risp[rispInd] + "!");
        }
